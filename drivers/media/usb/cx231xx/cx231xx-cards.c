	...
	case CX231XX_BOARD_HAUPPAUGE_975:
		{
			...
			tveeprom_hauppauge_analog(&e->client, &e->tvee, e->eeprom + 0xc0);
			kfree(e);
			break;
		}
	}
...
#if 0 //defined(CONFIG_MODULES) && defined(MODULE)
...
extern int cx231xx_dvb_register(void);
extern void cx231xx_dvb_unregister(void);
extern int cx231xx_alsa_register(void);
extern void cx231xx_alsa_unregister(void);
