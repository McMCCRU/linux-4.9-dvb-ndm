...
#else
static void af9013_statistics_get(struct af9013_state *state)
{
#endif
	unsigned int next_msec;

#ifndef WORK_ENABLE
	mutex_lock(&state->mutex_lock);
#endif
