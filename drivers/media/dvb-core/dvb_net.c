...
static int _eth_header(struct sk_buff *skb, struct net_device *dev,
               unsigned short type,
...
static int _eth_header_parse(const struct sk_buff *skb, unsigned char *haddr)
{
